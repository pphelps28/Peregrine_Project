...
class App extends Component {
	...
	weatherObservationChange = (event) => {
		this.setState({
			weatherObservation: event.target.value
		});
	};
	...
	searchDataBase = (event) => {
		...
		let query = {
			// this query is coming from the three search input fields
		...
		return (
			<div>
                ...
                image={image}
								...
								weatherObservationChange={weatherObservationChange}
								temperatureChange={temperatureChange}
								precipitationChange={precipitationChange}
								cloudCoverChange={cloudCoverChange}
								windSpeedChange={windSpeedChange}
								observationChange={observationChange}
								relationshipStatusChange={relationshipStatusChange}
								youngStatusChange={youngStatusChange}
								disturbanceChange={disturbanceChange}
								youngChange={youngChange}
								youngAgeChange={youngAgeChange}
								incubationChange={incubationChange}
